...
if __name__ == "__main__":
    ...
    normal_rmses = np.load("normal_rmses.npy")
    ...
    n, bins, patches = plt.hist(anomalous_rmses, bins=bin_list, facecolor='g', label="rmse of anomalous packets",
                                log=True)
    ...
    plt.savefig("results/fuzz_rmse.pdf", format="pdf", bbox_inches="tight")
    plt.show()